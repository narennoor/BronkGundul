...
2. No user spec → omit strategy (the system resolves it: config default, or the deterministic auto-picker when strategyMode is "auto") and choose bins based on volatility
...
- Strategy: omit the strategy field — the system resolves it (config.strategy.strategy default, or the deterministic width-based picker when strategyMode is "auto")
      ...
      parameters: {
        ...
        properties: {
          ...
          strategy: {
            type: "string",
            enum: ["bid_ask", "spot"],
            description: "DLMM strategy type. If user specifies, use exactly what they said. Otherwise ALWAYS omit — the system resolves it automatically (config default, or the deterministic auto-picker when strategyMode is \"auto\")."
          },
          bins_below: {
            type: "number",
